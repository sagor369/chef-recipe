...
const Chef = ({ chef }) => {
  ...
  return (
    <div className="border w-3/4 md:w-full ml-12 md:ml-0 rounded p-4 bg-white shadow-xl">
      <div>
      ...
      <p>
        Total Recipes: <span className="font-bold">{total_recipe} recipe</span>
      </p>
      <p className=" flex gap-2 items-center">
        <Rating style={{ maxWidth: 150 }} value={Math.floor(rat)} />{" "}
        <span>{rat}</span>
      </p>
