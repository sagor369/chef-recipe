...
const ChefCart = () => {
  ...
  return (
    ...
    <div className="bg-white rounded w-3/4 mx-auto p-4 my-6">
        <h1 className="text-orange-500 text-2xl font-bold text-center uppercase py-4">heire chef blog</h1>
        <p>
      ...
      <div className="bg-white rounded w-3/4 mx-auto p-4 mb-6">
        <h2 className="text-orange-500 uppercase text-2xl font-bold text-center ">Delivery Blog</h2>
        <p>
