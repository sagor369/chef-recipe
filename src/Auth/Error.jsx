    ...
    return (
        <div className='bg-gray-400 h-[110vh] flex justify-center items-center'>
            <div className='w-1/4 bordor '>
                <img className='w-96 rounded-full' src="https://img.freepik.com/free-vector/error-404-concept-landing-page_52683-21190.jpg?size=626&ext=jpg&ga=GA1.2.2077699082.1681132836&semt=sph" alt="" />
